    ...
    <div className="w-full z-40">
      ...
      <section className="ml-8 flex rounded-l-lg bg-[#1B2037]">
        <div className="w-full p-6">
          ...
          <p className="my-3 text-[26px] bespoke font-semibold">
            Business planning
          </p>
      ...
      <section className="py-32 flex justify-evenly bg-[#080C23]">
        <div className="w-[30vw]">
          <p className="text-[40px] my-4 bespoke font-bold">
      ...
      <section className=" pt-12 pb-32 text-center flex flex-col items-center">
        <p className="text-[40px] mt-12 bespoke font-bold">
          Transaction details
        </p>
        <p className="text-[14px] mt-6 mb-12 w-[480px]">
