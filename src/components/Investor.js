    ...
    <div className="">
      ...
      <div className="relative mx-20 py-32 h-[720px]">
        ...
        <div className=" absolute w-[35vw]">
          <p className="text-[40px] bespoke">If You Are Investor</p>
      ...
      <div className="p-6 px-[200px] mx-48 mb-20 text-center bg-[#1B2037] border border-slate-700 text-[16px] rounded-lg">
        <p className="text-[25px] my-6">Benefits</p>
        <p>
          * We are 100% funded from our own platform with a team of over 300
          professional FinTech investors who all believe the future of finance
        ...
        <p className="mt-6">* Business Planning</p>
      ...
      {/* partners */}
      <section className="text-center bg-[#03050e] py-12">
      ...
      <section className=" relative w-[100vw] mt-24 mb-48 text-[16px]  flex flex-col justify-center items-center">
        <p className="mt-12 my-4 text-[36px] bespoke font-bold">
          Business Listing
        </p>
        <p className="mb-16">
