    ...
    <div>
      ...
      <div className="relative mx-20 py-20 h-[720px]">
        ...
        <div className=" absolute w-[35vw]">
          <p className="text-[40px] bespoke">Raise Support</p>
      ...
      <div className="flex border border-slate-700 text-[25px] mx-20 mb-12 rounded-lg p-6 bg-slate-900 justify-between items-center">
        <div className="mx-16">Capital Raise Support</div>
        <div className="mx-16">Deal making/Capital raise</div>
      </div>
