    ...
    <div>
      ...
      <div className="relative mx-20 py-32 h-[720px]">
        ...
        <div className=" absolute w-[35vw]">
          <p className="text-[40px] bespoke">Our Servises</p>
          <p className="text-[16px] mt-6 ranade">
          ...
          <p className="text-[16px] my-6 ranade">
          ...
          <div className="flex text-[16px]">
            <button onClick={()=>setToggle(true)} className=' px-14 py-2 border border-white rounded-lg bg-gradient-to-r from-green-300 to-blue-800'>Know More</button>
            <button className='ml-4 px-8 py-2 border border-white rounded-lg'>Find the Package</button>
          </div>
        </div>
        <div></div>
      </div>
        ...
        {/* business planning */}
        <section className='ml-8 mb-28 flex rounded-l-lg bg-[#1B2037]'>
